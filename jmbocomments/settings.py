...
PROJECT_PATH = os.path.realpath(os.path.join(os.path.dirname(__file__), '..', 'jmbocomments'))
...
MIDDLEWARE_CLASSES = (
    ...
    'jmbocomments.middleware.VodacomTanzaniaRemoteUserMiddleware',
...
ROOT_URLCONF = 'jmbocomments.temp-urls'
