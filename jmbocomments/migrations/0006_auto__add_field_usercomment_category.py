...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserComment.category'
        db.add_column('jmbocomments_usercomment', 'category', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserComment.category'
        db.delete_column('jmbocomments_usercomment', 'category')
    ...
    models = {
        ...
        'jmbocomments.usercommentflag': {
            'Meta': {'object_name': 'UserCommentFlag'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flag_set'", 'to': "orm['jmbocomments.UserComment']"}),
